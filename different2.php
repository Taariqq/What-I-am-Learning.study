<?php
/*
 *  Using David's solution ... 
 *  create a login variable for if the user is logged in or not, hard
 * coded.
 */
$loggedIn = 0;
?>
...
<head>
    ...
    <link href="stylesDifferent.css" rel="stylesheet" type="text/css">
</head>
<body>
<div id="wrapper">
    <header class="both">
